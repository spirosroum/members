...
App.KIOSK_I18N = {
    en: {
        ...
        huntChallenge: 'challenged the King',
        huntNewKing: 'sat on the Throne',
        huntFirstKing: 'Claimed the Crown with {c} trainings.',
        huntMatched: 'Matched the record of {k}: {c} trainings.',
        ...
        huntOneAway: 'Only 1 point from the Crown!',
        ...
        memberViewRank90d: ' (last 90 days)',
        memberViewRank90dDesc: 'last 90 days',
        memberViewRankUnranked: 'Unranked',
        memberViewTotalTrainings: 'Total Trainings',
        memberViewTotalHours: 'Total Hours Trained',
        memberViewAvgWeek: 'Avg Trainings / Week',
        memberViewAvgMonth: 'Avg Trainings / Month',
        memberViewAvgDays: 'Avg Days / Week',
        memberViewAvgDaysMonth: 'Avg Days / Month',
        memberViewAvgDay: 'Avg Trainings / Day',
        memberViewStatsTitle: 'Statistics',
        memberViewWeek: 'Week',
        memberViewMonth: 'Month',
        memberViewAttendanceTitle: 'Training Stats',
        memberViewAttendanceWindow: 'Last 90 days',
        memberViewAttendanceOverall: 'Overall',
        memberViewAttendanceSessions: 'sessions',
        memberViewBestClass: 'Best Class',
        memberViewStreak: 'Streak',
        memberViewStreakWeek: 'week',
        memberViewStreakWeeks: 'weeks',
        memberExpiryBanner: 'Your membership expires in',
        memberViewAttendanceGood: 'Good',
        memberViewAttendanceFair: 'Fair',
        memberViewAttendanceLow: 'Low',
        memberViewNotAttending: 'Not attending',
        memberViewNoAttendance: 'No class sessions available in this period.',
        ...
        memberViewNoStats: 'No statistics to show.',
        memberStatusFrozen: 'Frozen',
        memberStatusCancelled: 'Cancelled',
        ...
        classSessionsPerWeek: 'sessions/week',
        planExpandDetails: 'View details',
        planCollapseDetails: 'Hide details',
        planValidityLabel: 'Valid for:',
        ...
        mobileMemberStats: 'Member Stats',
        ...
        gymSchedule: 'Training Schedule',
        scheduleSubtitle: 'Weekly class schedule.',
    ...
    el: {
        ...
        huntChallenge: 'προκάλεσε τον Βασιλιά',
        huntNewKing: 'κάθισε στον Θρόνο',
        ...
        huntOneAway: 'Μόνο 1 πόντο από το Στέμμα!',
        ...
        memberViewRank90d: ' (ΤΕΛΕΥΤΑΙΕΣ 90 ΗΜΕΡΕΣ)',
        memberViewRank90dDesc: 'τελευταίες 90 ημέρες',
        memberViewRankUnranked: 'Χωρίς κατάταξη',
        memberViewTotalTrainings: 'ΣΥΝΟΛΟ ΠΡΟΠΟΝΗΣΕΩΝ',
        memberViewTotalHours: 'ΣΥΝΟΛΟ ΩΡΩΝ ΠΡΟΠΟΝΗΣΗΣ',
        memberViewAvgWeek: 'Μ.Ο. ΠΡΟΠΟΝΗΣΕΙΣ / ΕΒΔΟΜΑΔΑ',
        memberViewAvgMonth: 'Μ.Ο. ΠΡΟΠΟΝΗΣΕΙΣ / ΜΗΝΑ',
        memberViewAvgDays: 'Μ.Ο. ΗΜΕΡΕΣ / ΕΒΔΟΜΑΔΑ',
        memberViewAvgDaysMonth: 'Μ.Ο. ΗΜΕΡΕΣ / ΜΗΝΑ',
        memberViewAvgDay: 'Μ.Ο. ΠΡΟΠΟΝΗΣΕΙΣ / ΗΜΕΡΑ',
        memberViewStatsTitle: 'ΣΤΑΤΙΣΤΙΚΑ',
        memberViewWeek: 'ΕΒΔΟΜΑΔΑ',
        memberViewMonth: 'ΜΗΝΑΣ',
        memberViewAttendanceTitle: 'ΣΤΑΤΙΣΤΙΚΑ ΠΡΟΠΟΝΗΣΗΣ',
        memberViewAttendanceWindow: 'Τελευταίες 90 ημέρες',
        memberViewAttendanceOverall: 'Συνολικά',
        memberViewAttendanceSessions: 'συνεδρίες',
        memberViewBestClass: 'Καλύτερο Μάθημα',
        memberViewStreak: 'Σερί',
        memberViewStreakWeek: 'εβδομάδα',
        memberViewStreakWeeks: 'εβδομάδες',
        memberExpiryBanner: 'Η συνδρομή σας λήγει σε',
        memberViewAttendanceGood: 'Καλή',
        memberViewAttendanceFair: 'Μέτρια',
        memberViewAttendanceLow: 'Χαμηλή',
        memberViewNotAttending: 'Δεν παρακολουθεί',
        memberViewNoAttendance: 'Δεν υπάρχουν διαθέσιμες συνεδρίες σε αυτή την περίοδο.',
        ...
        memberViewNoStats: 'Δεν υπάρχουν στατιστικά προς εμφάνιση.',
        memberStatusFrozen: 'Παγωμένος',
        memberStatusCancelled: 'Ακυρωμένος',
        ...
        classSessionsPerWeek: 'μαθήματα/εβδομάδα',
        planExpandDetails: 'Προβολή λεπτομερειών',
        planCollapseDetails: 'Απόκρυψη λεπτομερειών',
        planValidityLabel: 'Ισχύει για:',
        ...
        mobileMemberStats: 'ΤΑ ΣΤΑΤΙΣΤΙΚΑ ΜΟΥ',
        ...
        scheduleSubtitle: 'Εβδομαδιαίο πρόγραμμα μαθημάτων.',
...
App.applyKioskTranslations = function() {
    try {
        ...
        // 2) Translate the "Training Schedule" heading inside the kiosk schedule card (only within kiosk view)
        try {
            ...
            Array.from(document.querySelectorAll('#view-kiosk h3')).forEach(h3 => {
                ...
                if (scheduleHeadingLabels.has(txt)) h3.innerText = map.gymSchedule || 'Training Schedule';
            });
            const scheduleSubtitle = document.getElementById('kiosk-schedule-subtitle');
            if (scheduleSubtitle) scheduleSubtitle.innerText = map.scheduleSubtitle || 'Weekly class schedule.';
        } catch (e) { /* non-fatal */ }
