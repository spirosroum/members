...
const PRESET_PALETTE = ['#2563eb', '#059669', '#7c3aed', '#d97706', '#dc2626', '#0891b2', '#db2777', '#334155', '#f59e0b', '#10b981', '#8b5cf6', '#ef4444', '#0f766e', '#86198f'];
        ...
        function settingsPayload() {
            return {
                ...
                memberStatsVisibility: STATE.memberStatsVisibility || { totalTrainings: true, totalHours: true, avgWeek: true, avgDays: true, avgMonth: true, rank: true }
            };
        }
        ...
        function subscribeSettings() {
            ...
            FSEngine._subs['settings'] = db.collection('settings').doc('global').onSnapshot(doc => {
                if (doc.exists) {
                    ...
                    if (d.memberStatsVisibility) STATE.memberStatsVisibility = Object.assign({ totalTrainings: true, totalHours: true, avgWeek: true, avgDays: true, avgMonth: true, rank: true }, d.memberStatsVisibility);
        ...
        const DB = {
            ...
            getMemberStatsVisibility: () => Object.assign({ totalTrainings: true, totalHours: true, avgWeek: true, avgDays: true, avgMonth: true, rank: true }, STATE.memberStatsVisibility || {}),
