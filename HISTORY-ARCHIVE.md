# History Archive — GymDesk (Sloth Submission Grappling)

Archived older changelog entries. Moved here from `HISTORY.md` on 2026-08-10 to keep the active changelog short. Full history also lives in git.
